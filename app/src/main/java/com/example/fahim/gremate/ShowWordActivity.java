...
//
//        if(wordAllData_.getWordSentences().size()==0){
...
//                    wordSentences.add(w);
//                }
//                wordAllData_.setWordSentences(wordSentences);
//                setSentence();
//                countLoaded(3);
//            }
//            @Override
...
//                }
//                (new FetchImage(getApplicationContext(), wordId, images)).execute();
//            }
//
//            @Override
//            public void onCancelled(DatabaseError databaseError) {
...
//
//                wordAllData_.setWord(new Word(WORD.getCloneOf(), WORD.getListId(), WORD.getSourceListName(),
...
//                showWordSV.setVisibility(View.VISIBLE);
//                loading = false;
//                (new FetchImage(getApplicationContext(), wordId, wordAllData_.getImages())).execute();
//            }
//            else {
//                loadingPB.setVisibility(View.GONE);
//                showWordSV.setVisibility(View.GONE);
