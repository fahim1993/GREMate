...
public class FeedTestData {
    ...
    public String[] getWords() {
        String[] s = new String[]{
                "abate", "aberrant", "abeyance", "abhor", "abjure", "abortive", "abound", "abrogate", "abscond", "abstemious", "absurd", "access",
                "accommodate", "accomplice", "accost", "acknowledge", "acme", "acrimonious", "acute", "adamant", "adherent", "admonish", "adroit",
                "adulterate", "advent", "adversary", "adverse", "advocate", "aegis", "aesthetic", "afflict", "affluent", "aggregate", "alacrity",
                "allay", "alleged", "alleviate", "allude", "aloof", "altruistic", "amalgamate", "ambiguous", "ambivalence", "ameliorate", "amicable",
                "amnesty", "amorous", "anachronism", "analogous", "anarchy", "anathema", "annals", "anomalous", "anomaly", "anthropologist", "antipathy",
                "antiquated", "antithesis", "apathy", "appalled", "appease", "appellation", "apprise", "approbation", "appropriate", "arbiter",
                "arbitrary", "archaic", "ardent", "arduous", "array", "artifact", "artifice", "artless", "ascend", "ascertain", "ascetic", "asinine",
                "asperity", "aspirant", "aspire", "asset", "assiduous", "assuage", "astute", "atrophy", "attenuate", "attenuated", "attest", "atypical",
                "audacious", "audacity", "augment", "austere", "automaton", "autonomous", "avarice", "aver", "aversion", "avid", "awesome", "badger",
                "bagatelle", "balk", "banal", "barometer", "bedlam", "begrudge", "belated", "belie", "belittle", "belligerent", "beneficent", "benevolent",
                "bereft", "besiege", "besmirch", "bias", "bigot", "bizarre", "blase", "blatant", "bliss", "blunt", "bogus", "bolster", "bombastic",
                "boorish", "brash", "brigand", "bristle", "buff", "bulwark", "burgeon", "burgeoned", "burnish", "buttress", "cache", "cacophonous",
                "cacophony", "cajole", "callous", "callow", "calumny", "canard", "candid", "candor", "cant", "capitulate", "capricious", "carnage",
                "castigate", "castigation", "catastrophic", "caustic", "celerity", "cessation", "chagrin", "charisma", "charlatan", "chicanery",
                "chimerical", "clandestine", "cliche", "clique", "coagulate", "coda", "coerce", "cogent", "cognizant", "comely", "commensurate",
                "commodious", "compassion", "compatible", "compendium", "compensate",  "complacent", "complaisant", "compliant", "complicity",
                "component", "compound", "comprehensive", "conciliatory", "concoct", "concomitant", "concur", "condescend", "condolence", "condone",
                "conducive", "confidante", "conflagration", "confound", "confront", "congenial", "conjecture", "conjugal", "connoisseur", "connubial",
                "consternation", "constrict", "construe", "consummate", "contemptuous", "contention", "contentious", "contort", "contrite", "controversial",
                "conundrum", "converge", "convoluted", "cope", "copious", "corpulent", "corroborate", "coterie", "countenance", "coup", "covert", "covet",
                "crave", "craven", "criterion", "cryptic", "culminate", "culpable", "culprit", "cumbersome", "cumulative", "cupidity", "curry", "cursory",
                "curtail", "cynic", "daunt", "dearth", "debacle", "debilitate", "debris", "decade", "decadence", "decapitate", "declaim", "decorum",
                "decrepit", "deem", "defamatory", "default", "deference", "degrade", "deleterious", "delineate", "delineation", "delude", "deluge",
                "delve", "demeanor", "demur", "denigrate", "denote", "depict", "deplorable", "deploy", "deprecate", "deride", "derivative", "derived",
                "derogatory", "desiccate", "desist", "destitution", "desultory", "deter", "deterrent", "detriment", "devout", "dexterity", "diatribe",
                "dichotomy", "diffidence", "diffuse", "digression", "dilettante", "diminutive", "dirge", "disabuse", "discern", "discerning", "disciple",
                "discordant", "discredit", "discreet", "discrepancy", "disdain", "disgruntled", "disheveled", "disingenuous", "disinterested", "disjointed",
                "dismantle", "dismiss", "disparage", "disparate", "dispersed", "dissemble", "disseminate", "dissent", "dissolution", "dissonance", "distend",
                "distill", "distraught", "diverge", "diversity", "divest", "divulge", "docile", "document", "doddering", "dogmatic", "doleful", "domicile",
                "dormant", "dregs", "drudgery", "dubious", "dulcet", "dupe", "duplicity", "duress", "ebullient", "eclectic", "edifice", "efficacy", "effigy",
                "effrontery", "egotist", "egregious", "elapse", "elegy", "elicit", "elucidate", "elusive", "emaciated", "embellish", "eminent", "emissary",
                "emit", "empirical", "emulate", "encomium", "encumbrance", "endemic", "enervate", "engender", "engrossed", "enhance", "enigma", "ennui",
                "entourage", "entreaty", "enunciate", "ephemeral", "epithet", "epitome", "equanimity", "equivocate", "eradicate", "erudite", "eruption",
                "escalation", "eschew", "esoteric", "ethics", "eulogy", "euphemism", "evaluate", "evanescent", "evince", "exacerbate", "excoriate",
                "excruciating", "exculpate", "exhort", "exigency", "exonerate", "expatriate", "expedient", "expedite", "exploit", "expunge", "expurgate",
                "extant", "extinct", "extol", "extortion", "extraneous", "extrapolation", "extrinsic", "exult", "exultation", "fabricate", "facade",
                "facet", "facetious", "facile", "facilitate", "factitious", "fallacious", "falter", "fastidious", "fatal", "fatuous", "fawning",
                "feasible", "feint", "felicitous", "felon", "ferment", "fervid", "fetish", "fetter", "fiasco", "fiat", "flabbergasted", "flag", "flagrant",
                "flamboyant", "flay", "fledgling", "flout", "fluctuate", "foist", "foment", "forestall", "fortuitous", "fracas", "fractious", "frail",
                "fraught", "fray", "frenetic", "frenzy", "fretful", "frugal", "frugality", "fruitless", "frustrate", "fulsome", "furtive", "futile",
                "futility", "gainsay", "galvanize", "gamut", "garbled", "garrulous", "gaudy", "gaunt", "genocide", "genre", "germane", "gesticulate",
                "gist", "glean", "glib", "goad", "gouge", "grandiloquent", "gratuity", "gregarious", "grimace", "grotesque", "guileless", "guise",
                "gullible", "gusto", "habitat", "halcyon", "hapless", "harangue", "harass", "harbinger", "haven", "havoc", "heinous", "heresy",
                "heterogeneous", "hirsute", "histrionics", "hoard", "hoax", "homogeneous", "homogenous", "hostile", "humility", "hyperbole", "iconoclast",
                "iconoclastic", "idolatry", "idyllic", "ignominious", "ilk", "imbibe", "imminent", "immutable", "impair", "impassive", "impeccable",
                "impede", "imperative", "imperceptible", "impermeable", "imperturbable", "impervious", "impetuous", "impious", "implacable", "implicit",
                "implode", "implore", "importune", "impresario", "impromptu", "imprudent", "impunity", "inadvertent", "inadvertently", "inane", "inanimate",
                "incapacitated", "inchoate", "incipient", "incisive", "inclement", "incoherent", "incompatibility", "incongruity", "incongruous",
                "inconsequential", "incontrovertible", "incorporate", "incredulous", "incumbent", "indeterminate", "indict", "indifference", "indigence",
                "indigenous", "indigent", "indiscriminate", "indoctrinate", "indolent", "inebriated", "ineffectual", "inert", "inevitable", "inexorable",
                "infallible", "infamous", "infraction", "ingenuous", "ingratiate", "inherent", "inhibition", "iniquity", "initiate", "innate", "innocuous",
                "inordinate", "insatiable", "insensible", "insidious", "insinuate", "insipid", "insularity", "integral", "interject", "interloper",
                "interminable", "internecine", "interrogate", "intimidate", "intractable", "intransigence", "intrepid", "intrinsic", "introspective",
                "inundate", "inured", "invalidate", "invective", "inveigh", "inveterate", "inviolable", "irascible", "irate", "irrational", "irrelevant",
                "irresolute", "itinerant", "itinerary", "jaunty", "jeopardize", "jettison", "jocose", "jostle", "jubilant", "jurisdiction", "juxtapose",
                "labyrinth", "laceration", "lackluster", "laconic", "lampoon", "landmark", "lassitude", "latent", "laud", "laudable", "lax", "legerdemain",
                "legion", "lethal", "lethargic", "levee", "levity", "libel", "lithe", "livid", "loath", "loathe", "log", "longevity", "loquacious",
                "lucid", "lucrative", "lugubrious", "luminous", "lurid", "lush", "magnanimity", "magnanimous", "maim", "maladjusted", "malady", "malevolent",
                "malign", "malignant", "malingerer", "malleable", "malnutrition", "mammoth", "mandate", "manifest", "manifold", "martinet", "masticate",
                "materialism", "matron", "maudlin", "maverick", "megalomania", "mendacious", "menial", "mentor", "mercenary", "metamorphosis", "meticulous",
                "mien", "milieu", "misanthrope", "mitigate", "modify", "mollify", "monolithic", "moribund", "morose", "mortality", "mortify", "motivate",
                "mundane", "munificent", "murky", "myriad", "nadir", "naive", "nascent", "nebulous", "nefarious", "negate", "negligible", "neophyte",
                "nepotism", "nettle", "neurotic", "neutralize", "nirvana", "noisome", "nomadic", "nominal", "nondescript", "nonentity", "nostalgia",
                "nuance", "nullify", "nurture", "obdurate", "obese", "obliterate", "obloquy", "obscure", "obsequious", "obsess", "obsolescence", "obviate",
                "occlude", "occult", "officious", "ominous", "omnipotent", "omnivorous", "onerous", "opprobrium", "opulence", "originate", "oscillate",
                "ostensible", "ostentatious", "oust", "overt", "pall", "palliate", "paltry", "panacea", "pandemonium", "parable", "paradox", "paragon",
                "paramount", "pariah", "paroxysm", "parsimonious", "partisan", "passe", "pathetic", "pathological", "paucity", "pecuniary", "pedagogue",
                "pedantic", "penance", "penchant", "penitent", "pensive", "penury", "perceive", "peregrination", "peremptory", "perennial", "perfidious",
                "perfunctory", "permeable", "permeate", "pernicious", "perpetrate", "perpetuate", "persevere", "perspicacious", "pertinent", "peruse",
                "pervasive", "perverse", "pesky", "phenomenon", "phlegmatic", "phobia", "piety", "pinnacle", "pique", "pittance", "placard", "placate",
                "plaintiff", "plasticity", "platitude", "plethora", "plight", "plummet", "poignant", "ponder", "porous", "potent", "potentate", "potential",
                "potpourri", "pragmatic", "preamble", "precarious", "precedent", "precipitate", "preclude", "precocious", "precursor", "prelude", "premise",
                "premonition", "prerogative", "prestigious", "presumptuous", "pretext", "prevalent", "prevaricate", "prevarication", "pristine", "privation",
                "probity", "problematic", "procrastinate", "prodigal", "prodigious", "prodigy", "proffer", "profligate", "profound", "profuse", "progeny",
                "prognosticate", "prohibition", "prohibitive", "proliferate", "prolific", "promulgate", "propagate", "propensity", "propinquity",
                "propitiate", "propitious", "propriety", "proscribe", "proximity", "prudent", "pugnacious", "puissant", "pungent", "puny", "qualified",
                "qualm", "quandary", "quarry", "quell", "quibble", "quiescent", "quip", "rabid", "raconteur", "rail", "raiment", "rampant", "rarefied",
                "rash", "rationalize", "raucous", "raze", "realm", "rebuke", "recalcitrant", "recant", "recluse", "recoil", "recondite", "redolent",
                "redress", "refractory", "refute", "relegate", "remiss", "remote", "remuneration", "repent", "repertoire", "replenish", "replete",
                "repose", "reprehensible", "repress", "reprimand", "reproach", "reprobate", "repudiate", "repugnant", "repulse", "repute", "reputed",
                "requisite", "rescind", "resolution", "resolve", "resourceful", "respite", "restrictive", "reticent", "retort", "retrospect", "reverberate",
                    "reverberating", "revere", "reverent", "revert", "revile", "reviled", "rhetoric", "rife", "rift", "romp", "roster", "rudimentary", "rue",
                "ruminate", "rustic", "saga", "sage", "salient", "sally", "salubrious", "salvation", "sanctimonious", "sanction", "sanctuary", "sanguine",
                "satiate", "satiety", "saturate", "savor", "schism", "scion", "scoff", "scrutinize", "scurrilous", "scurry", "secrete", "sedate", "sedentary",
                "senile", "serenity", "servile", "shard", "shibboleth", "sinecure", "singular", "sinister", "skeptic", "skirmish", "slovenly",
                "sojourn", "solace", "solicit", "solicitous", "somber", "sophistry", "soporific", "sordid", "spate", "specious", "spectrum", "spontaneous",
                "sporadic", "spurious", "squeamish", "stagnant", "staunch", "steep", "steeped", "stentorian", "stereotype", "stigma", "stigmatize",
                "stint", "stipulate", "stolid", "striate", "strident", "strife", "strut", "stupor", "stymie", "subjugate", "subpoena", "subservient",
                "subside", "substantiate", "subterfuge", "subterranean", "succinct", "succulent", "succumb", "sullen", "sultry", "sumptuous",
                "superficial", "superfluous", "supersede", "supine", "supplication", "supposition", "surfeit", "surge", "surmise", "surreptitious",
                "susceptible", "symptomatic", "taboo", "tacit", "taint", "tangential", "tangible", "tantalize", "tantamount", "taut", "technology",
                "temerity", "tenable", "tenacious", "tenuous", "termagant", "terminate", "terse", "therapy", "throng", "thwart", "timorous", "tinge",
                "tirade", "tolerate", "torpor", "tortuous", "tractable", "tradition", "tranquil", "transgression", "transient", "tremulous", "trenchant",
                "trend", "trivial", "truculence", "truncated", "turbulent", "turpitude", "tussle", "tyro", "ubiquitous", "ultimate", "umbrage",
                "unconscionable", "unctuous", "underwrite", "universal", "unkempt", "unmitigated", "unsavory", "unwarranted", "unwieldy", "urbane",
                "usurp", "utopia", "vacillate", "valor", "vapid", "vehemently", "veneer", "venerable", "venerate", "venial", "venom", "veracious",
                "verbose", "vertigo", "vestige", "vexatious", "viable", "vicissitude", "vicissitudes", "vigil", "vigilant", "vilify", "vindicate",
                "virile", "virtuosity", "virulent", "viscous", "vitiate", "vitriolic", "vituperation", "vituperative", "vivacious", "vogue", "volatile",
                "volition", "voluble", "voluminous", "voracious", "vulnerable", "wan", "wane", "wary", "welter", "wheedle", "whet", "whimsical", "wince",
                "wistful", "wrest", "yen", "zealot", "zealous", "zenith"
